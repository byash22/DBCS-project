	...
	private void defectsChanged() {
	 ...
	 public void insertDBlifecycle(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	        	...
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3036/project","root","sawan");
	             Statement statement = connection.createStatement();
	             statement.executeUpdate("INSERT INTO life_cycle(life_cycle_name, life_cycle_description) VALUES('"+f1+"','"+f2+")");
	        	}
	        	catch(Exception e) {
