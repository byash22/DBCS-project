 ...
 */
class Mainline extends Application {
	/** 
	 * Class Attributes
	 */
	...
	static double CONTROL_PANEL_HEIGHT
	...
	override void start(Stage primaryStage) {
		...
		var Rectangle2D primaryScreenBounds = Screen::getPrimary().getVisualBounds()
